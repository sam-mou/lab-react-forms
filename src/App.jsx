...
function App() {
  ...
  const handleGratuatedInput = (e) => setGraduated(e.target.value);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label>
            ...
            <input value={program} onChange={handleProgramInput} />
          ...
          <label>
            Graduated
            <input name="graduated" type="checkbox" value={graduated} onChange={handleGratuatedInput} />
          </label>
